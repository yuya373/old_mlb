  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved favorite as @favorite" do
        ...
        post :create, {:favorite => { "team_id" => "invalid value" }}, valid_session
        assigns(:favorite).should be_a_new(Favorite)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested favorite" do
        ...
        Favorite.any_instance.should_receive(:update).with({ "team_id" => "1" })
        put :update, {:id => favorite.to_param, :favorite => { "team_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the favorite as @favorite" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Favorite.any_instance.stub(:save).and_return(false)
        put :update, {:id => favorite.to_param, :favorite => { "team_id" => "invalid value" }}, valid_session
        assigns(:favorite).should eq(favorite)
      end
