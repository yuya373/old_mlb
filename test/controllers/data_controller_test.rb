...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { day: @datum.day, gid: @datum.gid, month: @datum.month, team_id: @datum.team_id, team_name: @datum.team_name, year: @datum.year }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { day: @datum.day, gid: @datum.gid, month: @datum.month, team_id: @datum.team_id, team_name: @datum.team_name, year: @datum.year }
    assert_redirected_to datum_path(assigns(:datum))
  end
